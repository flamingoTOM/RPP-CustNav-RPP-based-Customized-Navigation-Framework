...
public:
  ...
  // double linearRegularization(double current_vel, double v_d);  // current_vel: 位姿计算的当前线速度
  // double angularRegularization(double current_ang_vel, double w_d);  // current_ang_vel: 位姿计算的当前角速度
