 ...
 */
rpp_pkg::vec2d::Vec2d tangentDir(const rpp_pkg::vec2d::Vec2d& pt_prev,
                                        const rpp_pkg::vec2d::Vec2d& pt,
                                        const rpp_pkg::vec2d::Vec2d& pt_next, bool is_cusp)
{
  rpp_pkg::vec2d::Vec2d center;
  ...
  if (std::isinf(center.x()) && std::isinf(center.y()))
  {
    ...
    auto result = rpp_pkg::vec2d::Vec2d(pt_next_cusp.x() - pt_prev.x(), pt_next_cusp.y() - pt_prev.y());
